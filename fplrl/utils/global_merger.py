...
def merge_data():
    """ Merge all the utils and export to a new file
    """
    ...
    df = df[['season', 'name', 'position', 'team', 'assists', 'bonus', 'bps', 'clean_sheets', 'creativity', 'element',
             ...
             'selected', 'team_a_score', 'team_h_score', 'threat', 'total_points', 'transfers_balance', 'transfers_in',
